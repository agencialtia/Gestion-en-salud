    ...
    <div id="view-program-detail" className="space-y-6 animate-in fade-in duration-150 text-left">
      ...
      {activeTab === 'indicadores' && (
        <div className="space-y-4">
          ...
          {/* Cuadro Resumen Global de Indicadores (Color bg-purple-600 destacado) */}
          {(() => {
            ...
            const meetsGoal = sumTargetWeighted > 0 ? relativeAchievementRatio >= 90 : sumWeightedCompliance >= 90;
            ...
            const activeCutDate = programIndicators.find((ind) => {
            ...
            return (
              <div className="rounded-2xl bg-purple-600 text-white p-3.5 sm:p-4 shadow-md border border-purple-500/60 space-y-3">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2.5">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-purple-950/40 text-purple-100 border border-purple-300/30 flex items-center gap-1">
                  ...
                  {/* Dynamic Status: CUMPLE / NO CUMPLE */}
                ...
                <div className="bg-purple-700/70 rounded-xl p-3 border border-purple-400/25 space-y-1.5">
                  <div className="flex items-center justify-between">
                  ...
                  <div className="w-full h-2 rounded-full bg-purple-950/50 overflow-hidden">
                    <div
                      ...
                      style={{ width: `${Math.min(100, Math.max(0, relativeAchievementRatio))}%` }}
                    />
                  </div>
                </div>
                ...
                {items.length > 0 && (
                  <div className="pt-2 border-t border-purple-500/40 space-y-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {items.map((item) => (
                        <div
                          key={item.id}
                          className="flex items-center justify-between bg-purple-800/70 border border-purple-400/20 px-3 py-2 rounded-xl text-xs gap-2"
                        >
                          <div className="truncate min-w-0">
                            <span className="font-mono font-bold text-purple-200 mr-1.5">
                              {item.code}:
                            </span>
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            ...
                            <span className="font-bold text-white bg-purple-950/80 px-2 py-0.5 rounded-lg border border-purple-400/30">
          ...
          <div className="flex items-center justify-start">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-purple-600 text-white rounded-xl text-xs font-bold hover:bg-purple-700 transition-colors shadow-sm cursor-pointer"
            >
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-5 space-y-4 shadow-xs">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-purple-600 text-white rounded-lg text-xs font-semibold hover:bg-purple-700 transition-colors shadow-xs cursor-pointer"
                  >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-3.5 rounded-2xl border border-slate-200 shadow-xs">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-purple-600 text-white rounded-lg text-xs font-semibold hover:bg-purple-700 transition-colors shadow-xs cursor-pointer shrink-0"
                >
              ...
              <div className="text-center py-10 bg-slate-50 rounded-2xl border border-dashed border-slate-200 space-y-1.5">
                ...
                <div className="pt-2">
                  <button
                    type="button"
                    onClick={() => onOpenQuickCreate('purchase')}
                    className="inline-flex items-center gap-1 px-3 py-1.5 bg-purple-600 text-white rounded-lg text-xs font-semibold hover:bg-purple-700 transition-colors shadow-xs cursor-pointer"
                  >
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 max-w-lg w-full overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50 flex items-center justify-end gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 bg-purple-600 text-white rounded-xl text-xs font-bold hover:bg-purple-700 transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
