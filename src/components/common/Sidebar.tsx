          ...
          <div className="flex h-16 items-center justify-between border-b border-slate-800 px-4 shrink-0">
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <div className="truncate">
                ...
                <p className="text-[10px] text-slate-400 font-medium truncate">{t('appSubtitle')}</p>
              </div>
            </div>
          ...
          <div className="flex-1 overflow-y-auto px-3 py-4 space-y-6 scrollbar-thin">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between px-3 py-1.5">
                ...
                >
                  <span>{t('programas2026')} ({programs.length})</span>
                  {programsOpen ? (
