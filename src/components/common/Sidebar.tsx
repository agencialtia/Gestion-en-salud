...
export const Sidebar: React.FC<{
  ...
  return (
    <>
      ...
      <aside
        id="main-sidebar"
        className={`fixed inset-y-0 left-0 z-50 flex h-full w-72 flex-col border-r border-slate-800 bg-slate-900 text-slate-200 transition-transform duration-300 ease-in-out lg:static lg:w-64 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between border-b border-slate-800 px-4">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-indigo-600 to-sky-500 text-white font-bold shadow-md">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-medium">Centro Operativo PRAPS</p>
            </div>
          </div>
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    if (item.id === 'dashboard') setSelectedProgramId(null);
                    onClose();
                  }}
        ...
        {/* Footer Info */}
        <div className="border-t border-slate-800 p-3 bg-slate-950/40 text-[11px] text-slate-400 flex items-center justify-between">
