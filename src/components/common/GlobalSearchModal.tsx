      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-slate-200 px-5 py-3.5 bg-slate-50">
          ...
          <button
            ...
            onClick={onClose}
            className="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-xs font-semibold text-slate-600 hover:bg-slate-100 hover:text-slate-900 hover:border-slate-300 transition-colors shadow-2xs cursor-pointer shrink-0"
          >
                      ...
                      >
                        <div>
                          ...
                          <p className="text-[11px] text-slate-500 mt-0.5">
                            Resp: {t.responsible} • Vence: {formatDate(t.dueDate)} • Estado: {t.status}
                          </p>
                        </div>
                    ...
                    {filteredPurchases.map((p) => (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-[11px] text-slate-500 mt-0.5">
                            ${((p.totalPriceWithTax ?? p.estimatedAmount) || 0).toLocaleString('es-CL')} • Proveedor: {p.supplier || 'Sin asignar'}
                          </p>
                        </div>
                    ...
                    {filteredEleam.map((e) => (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-[11px] text-slate-500 mt-0.5">
                            Próxima acción: {e.nextAction} • Plazo: {formatDate(e.deadline)}
                          </p>
                        </div>
