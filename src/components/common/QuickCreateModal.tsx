...
export const QuickCreateModal: React.FC<{ 
  ...
  const [purCeroPapelEstado, setPurCeroPapelEstado] = useState('En Trámite');
            ...
            <>
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-300 px-3 py-2 text-xs text-slate-800 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 p-3 rounded-xl bg-slate-50 border border-slate-200">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-indigo-300 bg-indigo-50/50 px-2.5 py-1.5 text-xs text-indigo-950 font-mono font-bold"
                    placeholder="$ 0"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-300 px-3 py-2 text-xs text-slate-800 pr-9 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                  />
                  {purRefLink.trim().length > 0 && (
                    <a
                      href={normalizeUrl(purRefLink)}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-700 mb-1">
                    Fecha Aceptación Orden de Compra
                  </label>
                  <input
                    type="date"
                    value={purOCAcceptedDate}
                    onChange={(e) => setPurOCAcceptedDate(e.target.value)}
                    className="w-full rounded-lg border border-slate-300 px-3 py-2 text-xs text-slate-800"
                  />
                </div>
              </div>
