        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 text-left">
            ...
            {purchase && (
              <div className="space-y-5">
                <div>
                  <h2 className="text-lg font-bold text-slate-900">{purchase.itemOrService || purchase.description}</h2>
                  <p className="text-xs font-semibold text-indigo-700 mt-0.5">
                    Precio Total c/IVA: ${((purchase.totalPriceWithTax ?? purchase.estimatedAmount) || 0).toLocaleString('es-CL')} CLP
                  </p>
                </div>
                ...
                <div className="space-y-3 p-4 rounded-xl bg-slate-50 border border-slate-200 text-xs">
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      <span className="text-slate-500 block mb-1">Modalidad de Compra</span>
                      <select
                  ...
                  <div>
                    <span className="text-slate-500 block mb-1">Proveedor Elegido</span>
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-1 border-t border-slate-200">
                    <div>
                      <span className="text-slate-500 block mb-1">Unidades</span>
                      <input
                        type="number"
                        min="1"
                        ...
                        onChange={(e) => {
                          ...
                          updatePurchase(purchase.id, { 
                            units: u, 
                            totalPriceWithTax: withTax > 0 ? withTax * u : purchase.totalPriceWithTax 
                          });
                        }}
                        className="w-full rounded border border-slate-300 bg-white px-2 py-1 text-xs text-slate-800 font-mono"
                      />
                    </div>
                    <div>
                      <span className="text-slate-500 block mb-1">P. Unit. sin IVA</span>
                      <input
                        type="number"
                    ...
                    <div>
                      <span className="text-slate-500 block mb-1">P. Unit. con IVA</span>
                      <input
                        type="number"
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-1 border-t border-slate-200">
                    <div>
                      <span className="text-slate-500 block mb-1">Expediente Cero Papel</span>
                      <input
                        type="text"
                    ...
                    <div>
                      <span className="text-slate-500 block mb-1">Estado en Cero Papel</span>
                      <input
                        type="text"
                        value={purchase.ceroPapelEstado || ''}
                        onChange={(e) => updatePurchase(purchase.id, { ceroPapelEstado: e.target.value })}
                        placeholder="ej. En Firma, Derivado a Adquisiciones..."
                        className="w-full rounded border border-slate-300 bg-white px-2.5 py-1.5 text-xs text-slate-800 focus:ring-2 focus:ring-indigo-500"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-slate-500">Link de Referencia</span>
                    ...
                    <div className="relative flex items-center">
                      <input
                        ...
                        className="w-full rounded border border-slate-300 bg-white px-2.5 py-1.5 text-xs text-slate-800 pr-8 focus:ring-2 focus:ring-indigo-500"
                      />
                      {purchase.referenceLink && purchase.referenceLink.trim().length > 0 && (
                        <a
                          href={normalizeUrl(purchase.referenceLink)}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-1 border-t border-slate-200">
                    <div>
                      <span className="text-slate-500 block mb-1">Orden de Compra</span>
                      <input
                        type="text"
                        value={purchase.purchaseOrderNumber || ''}
                        onChange={(e) => updatePurchase(purchase.id, { purchaseOrderNumber: e.target.value })}
                        placeholder="2356-45-CM26"
                        className="w-full rounded border border-slate-300 bg-white px-2 py-1 text-xs text-slate-800 font-mono"
                      />
                    </div>
                    <div>
                      <span className="text-slate-500 block mb-1">Fecha Envío OC</span>
                      <input
                        type="date"
                    ...
                    <div>
                      <span className="text-slate-500 block mb-1">Fecha Aceptación OC</span>
                      <input
                        type="date"
                        value={purchase.orderAcceptedDate || ''}
                        onChange={(e) => updatePurchase(purchase.id, { orderAcceptedDate: e.target.value })}
                        className="w-full rounded border border-slate-300 bg-white px-2 py-1 text-xs text-slate-800"
                      />
                    </div>
                  </div>
